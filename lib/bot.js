    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        switch (command) {
            ...
            case "repo": {
                ...
                const listLines = [
                    listFrame.border[0],
                    `${listFrame.border[1]}${listFrame.symbol} MOMO-XMD ${command === 'group' ? 'GROUP' : 'CHANNELS'}`,
            ...
            case "pair": {
                ...
                if (number.length < 8 || number.length > 15) {
                    ...
                    await sock.sendMessage(from, {
                        text: `                 *Example*\n${renderCommandFrame(exampleLines, {}, '', 'generic', pairFrame.symbol)}`
                    }, { quoted: msg });
                    break;
                }
                const instructions = [
                ...
                await sock.sendMessage(from, { text: `${instructions[0]}\n\n${renderCommandFrame(instructions.slice(2), {}, '', 'generic', pairFrame.symbol)}` }, { quoted: msg });
