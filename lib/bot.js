...
async function startBot(options = {}) {
    ...
    sock.ev.on('groups.update', async (updates = []) => {
        for (const update of updates) {
            ...
            const changes = [];
            if (typeof update.announce === 'boolean') changes.push(update.announce ? `${actorMention} closed the group` : `${actorMention} opened the group`);
            ...
            if (update.icon) changes.push(`${actorMention} changed the group profile picture`);
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        const groupCommands = new Set(["add", "announcements", "antibot", "antigif", "antilink", "antimention", "antileft", "antisticker", "antitag", "antiviewonce", "antivirus", "approve", "close", "demote", "goodbye", "kick", "kickall", "link", "listactive", "listcode", "listrequests", "open", "promote", "reject", "tosgroup", "welcome", "desc"]);
