    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        switch (command) {
            ...
            case "repo": {
                ...
                const listLines = [
                    listFrame.border[0],
                    `${listFrame.border[1]}${listFrame.symbol} MOMO-XMD CHANNELS`,
            ...
            case "pair": {
                ...
                if (number.length < 8 || number.length > 15) {
                    await sock.sendMessage(from, { text: renderCommandFrame([
                        ...
                        pairFrame.border[2]
                    ], {}, '', 'help', pairFrame.symbol) }, { quoted: msg });
                    break;
                }
                await sock.sendMessage(from, { text: `${pairFrame.symbol} generate code.....` }, { quoted: msg });
                ...
                try {
                    ...
                    const instructions = [
                        `${pairFrame.border[0]}`,
                        `${pairFrame.border[1]}${pairFrame.symbol} How to use🤳`,
                        ...
                        `${pairFrame.border[1]}${pairFrame.symbol} enter the code sent above`,
                        pairFrame.border[2]
                    ];
                    await sock.sendMessage(from, { text: renderCommandFrame(instructions, {}, '', 'generic', pairFrame.symbol) }, { quoted: msg });
                } catch (error) {
