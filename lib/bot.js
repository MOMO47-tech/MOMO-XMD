...
const downloadQuotedMedia = async (msg) => {
    ...
    const typeMap = { imageMessage: 'image', videoMessage: 'video', stickerMessage: 'sticker', audioMessage: 'audio', documentMessage: 'document' };
    ...
    if (!buffer.length) throw new Error('quoted media download returned empty data');
