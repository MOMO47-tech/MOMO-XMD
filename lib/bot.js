...
async function startBot(options = {}) {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        const groupCommands = new Set(["add", "announcements", "antibot", "antigif", "antilink", "antimention", "antileft", "antisticker", "antitag", "antiviewonce", "antivirus", "approve", "close", "demote", "getgcname", "getgcprofile", "goodbye", "kick", "kickall", "link", "listactive", "listcode", "listrequests", "open", "promote", "reject", "setdesc", "tosgroup", "welcome", "desc"]);
        const ownerCommands = new Set(["online", "antibug", "antidelete", "antispam", "autoread", "alive", "left", "hack", "autolikestatus", "autorecording", "autosavestatus", "autotyping", "autoviewonce", "autoviewstatus", "blacklist", "block", "chatbot", "create", "getpp", "listgroups", "mode", "restart", "setfont", "setpp", "setstatusemoj", "setstatus", "tosticker", "tovideo", "togif", "unblock", "vv", "vv2", "vps", "vpn", "logo", "hacker", "cyber", "neon", "fire", "gold", "royal", "luxury", "esport", "graffiti", "minimal", "wolf", "skull", "galaxy", "glitch", "samurai", "lion", "crown", "lightning", "matrix", "diamond", "tech", "retro", "racing", "music", "space"]);
        const senderJid = msg.key.participant || msg.key.remoteJid || "";
