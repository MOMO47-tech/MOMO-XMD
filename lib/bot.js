...
const COMMAND_STYLES = {
  autoviewstatus: { help: ['╭━━❐━⪼', '┇◈ 𝙰𝚄𝚃𝙾𝚅𝙸𝙴𝚆𝚂𝚃𝙰𝚃𝚄𝚂', '┇', '┇ ✦ autoviewstatus on', '┇ ✦ autoviewstatus off', '╰━━❑━⪼'], success: ['╭━━◈━⪼', '┇◈ AUTOVIEWSTATUS ${state}', '┇◈ status updated', '╰━━◇━⪼'], helpFooter: '> ❖ Powered by MOMO47 ❖', successFooter: '> ✦ Powered by MOMO47 ✦' },
  autoreact: { help: ['╭◆', '│◇ 𝙰𝚄𝚃𝙾𝚁𝙴𝙰𝙲𝚃', '│', '│ ★ autoreact on', '│ ★ autoreact off', '╰◆'], success: ['╭━━❖━⪼', '┇❖ AUTOREACT ${state}', '╰━━❖━⪼'], helpFooter: '> ◈ Powered by MOMO47 ◈', successFooter: '> ❑ Powered by MOMO47 ❑' },
  chatbot: { help: ['╭◆', '│◉ 𝙲𝙷𝙰𝚃𝙱𝙾𝚃', '│', '│ ๏ chatbot on', '│ ๏ chatbot off', '╰◆'], success: ['╭━━◉━⪼', '┇◉ CHATBOT ${state}', '╰━━◉━⪼'], helpFooter: '> ◇ Powered by MOMO47 ◇', successFooter: '> ★ Powered by MOMO47 ★' },
  online: { help: ['╭━━❐━⪼', '┇', '┇', '┇ ✦ online on', '┇ ✦ online off', '╰━━❑━⪼'], success: ['╭◆', '│ ONLINE ${state}', '╰◆'], helpFooter: '> ❖ Powered by MOMO47 ❖', successFooter: '> ★ Powered by MOMO47 ★' },
  autolikestatus: { help: ['╭◆', '│❖ 𝙰𝚄𝚃𝙾𝙻𝙸𝙺𝙴𝚂𝚃𝙰𝚃𝚄𝚂', '│', '│ ❖ autolikestatus on', '│ ❖ autolikestatus off', '╰◆'], success: ['╭━━๏━⪼', '┇๏ AUTOLIKESTATUS ${state}', '╰━━๏━⪼'], helpFooter: '> ◈ Powered by MOMO47 ◈', successFooter: '> ❑ Powered by MOMO47 ❑' },
  autosavestatus: { help: ['╭◆', '│❑ 𝙰𝚄𝚃𝙾𝚂𝙰𝚅𝙴𝚂𝚃𝙰𝚃𝚄𝚂', '│', '│ ❑ autosavestatus on', '│ ❑ autosavestatus off', '╰◆'], success: ['╭━━✦━⪼', '┇✦ AUTOSAVESTATUS ${state}', '╰━━✦━⪼'], helpFooter: '> ◇ Powered by MOMO47 ◇', successFooter: '> ★ Powered by MOMO47 ★' },
  autoviewonce: { help: ['╭◆', '│◇ 𝙰𝚄𝚃𝙾𝚅𝙸𝙴𝚆𝙾𝙽𝙲𝙴', '│', '│ ◇ autoviewonce on', '│ ◇ autoviewonce off', '╰◆'], success: ['╭━━❖━⪼', '┇❖ AUTOVIEWONCE ${state}', '╰━━❖━⪼'], helpFooter: '> ✦ Powered by MOMO47 ✦', successFooter: '> ◈ Powered by MOMO47 ◈' },
  autorecording: { help: ['╭━━❐━⪼', '┇๏ 𝙰𝚄𝚃𝙾𝚁𝙴𝙲𝙾𝚁𝙳𝙸𝙽𝙶', '┇', '┇ ๏ autorecording on', '┇ ๏ autorecording off', '╰━━❑━⪼'], success: ['╭◆', '│✦ AUTORECORDING ${state}', '╰◆'], helpFooter: '> ❖ Powered by MOMO47 ❖', successFooter: '> ◇ Powered by MOMO47 ◇' },
  autotyping: { help: ['╭◆', '│★ 𝙰𝚄𝚃𝙾𝚃𝚈𝙿𝙸𝙽𝙶', '│', '│ ★ autotyping on', '│ ★ autotyping off', '╰◆'], success: ['╭━━◈━⪼', '┇◈ AUTOTYPING ${state}', '╰━━◈━⪼'], helpFooter: '> ❑ Powered by MOMO47 ❑', successFooter: '> ✦ Powered by MOMO47 ✦' }
};
...
const ON_OFF_SUCCESS_FRAMES = {
  autoviewstatus: { on: ['╭━━◈━⪼', '┇◈', '╰━━◇━⪼', '> ✦ Powered by MOMO47 ✦'], off: ['╭◆', '│◇', '╰◆', '> ❑ Powered by MOMO47 ❑'] },
  autoreact: { on: ['╭━━❖━⪼', '┇❖', '╰━━❖━⪼', '> ★ Powered by MOMO47 ★'], off: ['╭━━✦━⪼', '┇✦', '╰━━✦━⪼', '> ◇ Powered by MOMO47 ◇'] },
  chatbot: { on: ['╭━━◉━⪼', '┇◉', '╰━━◉━⪼', '> ◈ Powered by MOMO47 ◈'], off: ['╭━━๏━⪼', '┇๏', '╰━━๏━⪼', '> ❑ Powered by MOMO47 ❑'] },
  online: { on: ['╭━━✦━⪼', '┇✦', '╰━━✦━⪼', '> ❖ Powered by MOMO47 ❖'], off: ['╭━━❑━⪼', '┇❑', '╰━━❑━⪼', '> ◇ Powered by MOMO47 ◇'] },
  autolikestatus: { on: ['╭━━๏━⪼', '┇๏', '╰━━๏━⪼', '> ◈ Powered by MOMO47 ◈'], off: ['╭━━❖━⪼', '┇❖', '╰━━❖━⪼', '> ✦ Powered by MOMO47 ✦'] },
  autosavestatus: { on: ['╭━━❑━⪼', '┇❑', '╰━━❑━⪼', '> ★ Powered by MOMO47 ★'], off: ['╭━━◈━⪼', '┇◈', '╰━━◈━⪼', '> ๏ Powered by MOMO47 ๏'] },
  autoviewonce: { on: ['╭━━◇━⪼', '┇◇', '╰━━◇━⪼', '> ❖ Powered by MOMO47 ❖'], off: ['╭━━✦━⪼', '┇✦', '╰━━✦━⪼', '> ◉ Powered by MOMO47 ◉'] },
  autorecording: { on: ['╭◆', '│★', '╰◆', '> ❑ Powered by MOMO47 ❑'], off: ['╭◆', '│๏', '╰◆', '> ◈ Powered by MOMO47 ◈'] },
  autotyping: { on: ['╭━━◈━⪼', '┇◈', '╰━━◈━⪼', '> ✦ Powered by MOMO47 ✦'], off: ['╭━━❖━⪼', '┇❖', '╰━━❖━⪼', '> ◇ Powered by MOMO47 ◇'] }
};
const renderCommandSuccess = (command, state) => {
    const enabled = state === 'ENABLED';
    const frame = ON_OFF_SUCCESS_FRAMES[command]?.[enabled ? 'on' : 'off'] || ['╭◆', '│◇', '╰◆', '> ❑ Powered by MOMO47 ❑'];
    return `${frame[0]}\n${frame[1]} ${command.toUpperCase()} ${state} SETTING SUCCESSFUL ✅\n${frame[2]}\n${frame[3]}`;
};
const ANTILINK_STYLES = {
  delete: { help: ['╭◆', '│◇ antilink delete on/off', '╰◆'], success: ['╭━━✦━⪼', '┇✦ ANTILINK DELETE ${state}', '┇✦ delete setting updated', '╰━━✧━⪼'] },
  warn: { help: ['╭━━❐━⪼', '┇๏ antilink warn on/off', '╰━━❑━⪼'], success: ['╭━━⬡━⪼', '┇⬡ ANTILINK WARN ${state}', '┇⬡ warning setting updated', '╰━━⬢━⪼'] },
  kick: { help: ['╭━━◉━⪼', '┇★ antilink kick on/off', '╰━━◉━⪼'], success: ['╭━━✺━⪼', '┇✺ ANTILINK KICK ${state}', '┇✺ kick setting updated', '╰━━✹━⪼'] }
};
...
const renderAntilinkSuccess = (action, state) => {
    const lines = ANTILINK_STYLES[action].success.map(line => line.replace(/\$\{state\}/g, state)).filter(line => !/setting\s+(saved|updated)|warning\s+setting\s+updated|delete\s+setting\s+updated|kick\s+setting\s+updated/i.test(line));
    const target = lines.findIndex(line => line.includes(state));
    if (target >= 0) {
        const prefix = lines[target].match(/^([│┇]\s*[^A-Za-z0-9]*)/)?.[1] || '┇ ';
        lines[target] = `${prefix}ANTILINK ${action.toUpperCase()} ${state} SETTING SUCCESSFUL ✅`;
    }
    return `${renderAntilinkFrame(lines, {}, '> ✦ Powered by MOMO47 ✦')}`;
};

const runtimeSettings = { mode: config.mode || "public", anticall: false, chatbot: false, autoviewstatus: false, autolikestatus: false, autosavestatus: false, autoviewonce: false, autoreact: false, autorecording: false, autotyping: false, online: false, antiforeign: false };
...
> ▣ Powered by MOMO47 ▣`;
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        if (await enforceAntilink(sock, from, msg, body)) return;
