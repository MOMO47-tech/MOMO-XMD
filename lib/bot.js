    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        switch (command) {
            ...
            case "alive": {
                ...
                saveGroupSettings();
                await sock.sendMessage(from, { text: 'You have successfully set this bot to stay in the group. ✅' }, { quoted: msg });
                break;
            }
            case "left": {
