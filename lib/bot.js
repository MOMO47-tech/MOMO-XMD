    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        switch (command) {
            ...
            case 'pair': {
                ...
                // Send a separate message with just the instructions for copy-paste if code is generated
                // But since this is just the command, we don't have the code yet.
                // The pairing server handles the code generation.
                break;
            }
            case 'listchat': {
