...
┃ ✧ Status: 🟢 Online
┃ ✧ Time: ${connectedAt}
┃ ✧ Channel 1: ${config.channelLink}
┃ ✧ Channel 2: ${config.supportChannel}
┗━━━━━━━━━━━━━━━━━━━━━━┛`;
            ...
            const notification = {
                ...
                contextInfo: {
                    externalAdReply: {
                        title: 'MOMO-XMD SERVER ONLINE',
                        body: 'Owner MOMO47 ☠️',
                        thumbnailUrl: 'https://raw.githubusercontent.com/MOMO47-tech/MOMO-XMD/main/media/momo_hacker.png',
            ...
            for (let attempt = 1; attempt <= 3 && !delivered; attempt++) {
                try {
                    ...
                    await sock.sendMessage(targetJid, notification);
                    delivered = true;
...
➥ *Enter the code sent below:*` + commandFooter());
                ...
                case 'create': {
                    ...
                    try {
                        ...
                        // Baileys requires at least one initial participant or bot user
