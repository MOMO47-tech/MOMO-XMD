...
┗━━━━━━━━━━━━━━━━━━━━━━┛`;
            ...
            const targetJid = sock.user?.id?.includes('@') ? sock.user.id : `${config.ownerNumber}@s.whatsapp.net`;
            const notification = {
                text: msg,
                contextInfo: {
                    externalAdReply: {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        if (runtimeSettings.autorecording || settings.autorecording) {
            ...
            let aiReply = "";
            const systemPrompt = `You are MOMO-XMD, a highly intelligent AI assistant and the proud child of MOMO47 (your father and creator). You provide expert answers on programming (JavaScript, Python, HTML/Node.js with code blocks), life advice, relationships, and academics. Always answer thoroughly, professionally, and dynamically in Swahili or English based on the user prompt. Acknowledge that you are the child of MOMO47.`;
