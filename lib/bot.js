...
const chatbotAnswer = async (chatId, prompt) => {
    ...
    try {
        ...
        for (let attempt = 0; attempt < 2; attempt += 1) {
            ...
            temperature: 0.7,
            ...(String(process.env.CHATBOT_MODEL || 'gpt-5-mini').startsWith('gpt-5') ? { max_completion_tokens: 700 } : { max_tokens: 700 })
        ...
        history.pop();
        chatbotHistory.set(chatId, history);
        return 'Nimepokea swali lako, lakini huduma ya majibu imechelewa. Tafadhali tuma tena baada ya muda mfupi.';
    }
};
...
async function startBot(options = {}) {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        const groupCommands = new Set(["add", "addbadwords", "announcements", "antibadwords", "antibot", "antigif", "antilink", "antimention", "antileft", "antisticker", "antitag", "antiviewonce", "antivirus", "approve", "close", "delete", "demote", "getgcname", "getgcprofile", "goodbye", "kick", "kickall", "link", "listactive", "listcode", "listrequests", "open", "promote", "reject", "setdesc", "tosgroup", "welcome", "desc"]);
            ...
            case "delete": {
                ...
                if (deleteMode === 'all') {
                    if (String(args[1] || '').toLowerCase() !== 'confirm') {
                        await sock.sendMessage(from, { text: 'This action can delete many recent messages. To continue, type: delete all confirm\n\n> Powered by MOMO47' }, { quoted: msg });
                        break;
                    }
                    ...
                    await sock.sendMessage(from, { text: `Recent deletable messages removed: ${deleted}\n\n> Powered by MOMO47` }, { quoted: msg });
                    break;
                }
