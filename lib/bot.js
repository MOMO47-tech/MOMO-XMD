        ...
        try {
            ...
            for (const participant of participants) {
                ...
                const lines = action === 'add'
                    ? [
                        frame.border[0],
                        `${frame.border[1]}${frame.symbol} karibu ${mention} kwenye ${groupName}`,
                        `${frame.border[1]}${frame.symbol} tunafurahi kukuona hapa`,
                        `${frame.border[1]}${frame.symbol} wewe ni member namba ${memberCount}`,
                        frame.border[2]
                    ]
                    : [
                        frame.border[0],
                        `${frame.border[1]}${frame.symbol} tutaendelea kukukumbuka ${mention}`,
                        `${frame.border[1]}${frame.symbol} umeondoka kwenye ${groupName}`,
                        `${frame.border[1]}${frame.symbol} members waliobaki: ${memberCount}`,
                        frame.border[2]
                    ];
            ...
            case "repo": {
                if (command === 'repo') {
                    ...
                    const repoLines = [
                        ...
                        `${repoFrame.border[1]}${repoFrame.symbol} https://github.com/MOMO47-tech/MOMO-XMD`,
