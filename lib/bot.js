...
const runtimeSettings = { mode: config.mode || "public", anticall: false, chatbot: false, autoviewstatus: false, autolikestatus: false, autosavestatus: false, autoviewonce: false, autoreact: false, autorecording: false, autotyping: false, online: false, antibug: false, antispam: false, antiforeign: false, antimention: false, antitag: false, antisticker: false, antigif: false, statusEmoji: '❤️', font: 0 };
...
try {
    if (fs.existsSync(runtimeSettingsPath)) {
        ...
        for (const setting of ['antibug', 'antispam', 'chatbot', 'antimention', 'antitag', 'antisticker', 'antigif']) {
...
async function startBot(options = {}) {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        const ownerCommands = new Set(["online", "antibug", "antispam", "autolikestatus", "autorecording", "autosavestatus", "autotyping", "autoviewonce", "autoviewstatus", "blacklist", "block", "chatbot", "create", "getpp", "mode", "restart", "runtime", "say", "setfont", "setstatusemoj", "setstatus", "tostatus", "unblock", "vv", "vv2", "vps", "vpn"]);
        const senderJid = msg.key.participant || msg.key.remoteJid || "";
