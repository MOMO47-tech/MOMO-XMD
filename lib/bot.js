        ...
        switch (command) {
            ...
            case 'anticall': {
                ...
                if (opt === 'on') { 
                    ...
                    await reply(sock, from, msg, formatBox("Anticall enabled!", 'downloader', '✅')); 
                } else if (opt === 'off') { 
                    runtimeSettings.anticall = false; 
                    await reply(sock, from, msg, formatBox("Anticall disabled!", 'downloader', '❌')); 
                } else {
            ...
            case 'antilink': {
                ...
                if (opt === 'on') { 
                    ...
                    saveGroupSettings(); 
                    await reply(sock, from, msg, formatBox("Antilink enabled (Delete)!", 'downloader', '✅')); 
                } else if (opt === 'off') { 
                    groupSettings.set(from, { ...current, antilink: false }); 
                    saveGroupSettings(); 
                    await reply(sock, from, msg, formatBox("Antilink disabled!", 'downloader', '❌')); 
                } else {
