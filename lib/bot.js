...
try {
    if (fs.existsSync(runtimeSettingsPath)) {
        ...
        for (const setting of ['antibug', 'antispam', 'chatbot', 'antidelete', 'antimention', 'antitag', 'antisticker', 'antigif', 'autoviewonce', 'autoviewstatus', 'autolikestatus', 'autosavestatus']) {
...
async function startBot(options = {}) {
    ...
    sock.ev.on("messages.upsert", async (m) => {
        ...
        const ownerCommands = new Set(["online", "antibug", "antidelete", "antispam", "alive", "left", "hack", "autolikestatus", "autorecording", "autosavestatus", "autotyping", "autoviewonce", "autoviewstatus", "blacklist", "block", "chatbot", "create", "getpp", "mode", "restart", "setfont", "setstatusemoj", "setstatus", "tosticker", "tovideo", "togif", "unblock", "vv", "vv2", "vps", "vpn", "logo", "hacker", "cyber", "neon", "fire", "gold", "royal", "luxury", "esport", "graffiti", "minimal", "wolf", "skull", "galaxy", "glitch", "samurai", "lion", "crown", "lightning", "matrix", "diamond", "tech", "retro", "racing", "music", "space"]);
        const senderJid = msg.key.participant || msg.key.remoteJid || "";
