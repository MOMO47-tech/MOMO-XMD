...
const menuText = (pushname = '', uptime = '0s', speed = '0.000 ms', mode = 'public') => {
  ...
  const ownerRows = [
    '│◇ antibug', '│◇ antidelete', '│◇ antispam', '│◇ alive', '│◇ autolikestatus', '│◇ autorecording', '│◇ autosavestatus', '│◇ autotyping', '│◇ autoviewonce', '│◇ autoviewstatus', '│◇ blacklist', '│◇ block', '│◇ channel', '│◇ chatbot', '│◇ create', '│◇ getpp', '│◇ hack', '│◇ hidetag', '│◇ left', '│◇ mode', '│◇ online', '│◇ owner', '│◇ pair', '│◇ ping', '│◇ repo', '│◇ restart', '│◇ runtime', '│◇ say', '│◇ setfont', '│◇ setstatus emoji', '│◇ tagall', '│◇ togif', '│◇ tosgroup', '│◇ tostatus', '│◇ tosticker', '│◇ tovideo', '│◇ unblock', '│◇ vv', '│◇ vv2'
  ].sort((a, b) => a.localeCompare(b));
  const groupRows = [
    '┇๏ add', '┇๏ announcements', '┇๏ antibot', '┇๏ antigif', '┇๏ antilink', '┇๏ antimention', '┇๏ antileft', '┇๏ antisticker', '┇๏ antitag', '┇๏ antiviewonce', '┇๏ antivirus', '┇๏ approve', '┇๏ close', '┇๏ demote', '┇๏ desc', '┇๏ getgcname', '┇๏ getgcprofile', '┇๏ goodbye', '┇๏ kick', '┇๏ kickall', '┇๏ link', '┇๏ listactive', '┇๏ listcode', '┇๏ listrequests', '┇๏ open', '┇๏ promote', '┇๏ reject', '┇๏ setdesc', '┇๏ tosgroup', '┇๏ welcome'
  ].sort((a, b) => a.localeCompare(b));
