...
const menuText = (pushname = '', uptime = '0s', speed = '0.000 ms', mode = 'public') => {
  ...
  const groupRows = [
    '┇๏ add', '┇๏ addbadwords', '┇๏ announcements', '┇๏ antibadwords', '┇๏ antibot', '┇๏ antigif', '┇๏ antilink', '┇๏ antimention', '┇๏ antileft', '┇๏ antisticker', '┇๏ antitag', '┇๏ antiviewonce', '┇๏ antivirus', '┇๏ approve', '┇๏ close', '┇๏ delete', '┇๏ demote', '┇๏ desc', '┇๏ getgcname', '┇๏ getgcprofile', '┇๏ goodbye', '┇๏ kick', '┇๏ kickall', '┇๏ link', '┇๏ listactive', '┇๏ listcode', '┇๏ listrequests', '┇๏ open', '┇๏ promote', '┇๏ reject', '┇๏ setdesc', '┇๏ tosgroup', '┇๏ welcome'
  ].sort((a, b) => a.localeCompare(b));
