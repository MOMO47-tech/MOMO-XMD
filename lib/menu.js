...
const menuText = (pushname = '', uptime = '0s', speed = '0.000 ms', mode = 'public') => {
  ...
  const logo = section(
    ...
    '╭━━✿━⪼',
    [
      '┇✿ hacker [name]', '┇✿ cyber [name]', '┇✿ neon [name]', '┇✿ fire [name]', '┇✿ gold [name]',
      '┇✿ royal [name]', '┇✿ luxury [name]', '┇✿ esport [name]', '┇✿ graffiti [name]', '┇✿ minimal [name]',
      '┇✿ wolf [name]', '┇✿ skull [name]', '┇✿ galaxy [name]', '┇✿ glitch [name]', '┇✿ samurai [name]',
      '┇✿ lion [name]', '┇✿ crown [name]', '┇✿ lightning [name]', '┇✿ matrix [name]', '┇✿ diamond [name]'
    ],
    '╰━━✿━⪼',
    '✿'
  );
