...
const menuText = (pushname, uptime, speed, usage, mode) => {
    ...
    const groupCommands = ['add', 'antilink', 'antigroupmention', 'kick', 'promote', 'demote', 'welcome', 'goodbye', 'open', 'close', 'announcements', 'antiviewonce', 'listrequests', 'listcode', 'link'];
