...
const menuText = (pushname, uptime, speed, usage, mode) => {
    ...
    const ownerCommands = ['autoviewstatus', 'autolikestatus', 'setstatusemoj', 'autosavestatus', 'restart', 'setfont', 'chatbot/aichat', 'autorecording', 'autotyping', 'alwaysonline', 'owner', 'pairing', 'ping', 'repo', 'runtime', 'channel', 'mode', 'tagall', 'hidetag'];
