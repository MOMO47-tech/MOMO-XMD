...
const menuText = (pushname = '', uptime = '0s', speed = '0.000 ms', mode = 'public') => {
  ...
  const ownerRows = [
    '│◇ antibug', '│◇ antidelete', '│◇ antispam', '│◇ alive', '│◇ autoread on/off', '│◇ autolikestatus', '│◇ autorecording', '│◇ autosavestatus', '│◇ autotyping', '│◇ autoviewonce', '│◇ autoviewstatus', '│◇ blacklist', '│◇ block', '│◇ channel', '│◇ chatbot', '│◇ create', '│◇ getpp', '│◇ hack', '│◇ hidetag', '│◇ left', '│◇ listgroups', '│◇ mode', '│◇ online', '│◇ owner', '│◇ pair', '│◇ ping', '│◇ repo', '│◇ restart', '│◇ runtime', '│◇ say', '│◇ setfont', '│◇ setpp', '│◇ setstatus emoji', '│◇ tagall', '│◇ togif', '│◇ tosgroup', '│◇ tostatus', '│◇ tosticker', '│◇ tovideo', '│◇ unblock', '│◇ vv', '│◇ vv2'
